...
R=Path(__file__).resolve().parent;sys.path.insert(0,str(R.parent));from sampled_interventions.simulate import GEOS
...
O=R.parent/'language_models/experiments/sampled_interventions';O.mkdir(parents=True,exist_ok=True)
def save(fig,name):
 for ext in ['png','pdf']:
